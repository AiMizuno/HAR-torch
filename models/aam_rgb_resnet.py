...
__all__ = ['ResNet', 'rgb_aamresnet50', 'rgb_aamresnet50_aux', 'rgb_aamresnet101',
           'rgb_aamresnet152']
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.sa = SpatialAttention(planes * 4)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.cfa = ClassificationAttention(num_classes)
...
def rgb_aamresnet50(pretrained=False, **kwargs):
...
def rgb_aamresnet50_aux(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
...
def rgb_aamresnet101(pretrained=False, **kwargs):
...
def rgb_aamresnet152(pretrained=False, **kwargs):
