...
def rgb_seresnet18(pretrained=False, **kwargs):
...
def rgb_seresnet34(pretrained=False, **kwargs):
...
def rgb_seresnet50(pretrained=False, **kwargs):
...
def rgb_seresnet50_aux(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
...
def rgb_seresnet101(pretrained=False, **kwargs):
...
def rgb_seresnet152(pretrained=False, **kwargs):
