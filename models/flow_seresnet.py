...
def flow_seresnet18(pretrained=False, **kwargs):
...
def flow_seresnet34(pretrained=False, **kwargs):
...
def flow_seresnet50(pretrained=False, **kwargs):
...
def flow_seresnet50_aux(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
...
def flow_seresnet101(pretrained=False, **kwargs):
...
def flow_seresnet152(pretrained=False, **kwargs):
