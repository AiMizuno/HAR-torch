...
def rgb_cbamresnet50(pretrained=False, **kwargs):
...
def rgb_cbamresnet50_aux(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
...
def rgb_cbamresnet101(pretrained=False, **kwargs):
...
def rgb_cbamresnet152(pretrained=False, **kwargs):
